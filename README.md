...
* Volatility Analysis
* Industry-wise Performance Comparison
...
market performance, identify high-performing stocks, compare industries, and detect trading patterns.
...
Trading activity peaked around Days 5, 12, 18, and 27, highlighting periods of increased investor activity.

The volatility analysis showed that 60.68% of stocks experienced low volatility, reflecting a 
relatively stable market, while 39.32% displayed higher price fluctuations. The market was slightly 
bearish overall, although significant price movements occurred during specific trading periods.

Monthly analysis indicated that January and  July recorded the highest 
trading volumes, whereas September achieved the highest average opening and closing prices despite lower trading activity. 
The IT industry emerged as the leading sector based on trading volume and closing values, while TATAELXSI 
and TCS were identified as the most volatile stocks. Overall, the dashboard demonstrates how Power BI can 
convert raw financial data into meaningful business insights through interactive visualizations and real-time analysis.
